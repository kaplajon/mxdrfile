function varargout = pdbwrite_ML(filename, pdbstruct)
...
% ML: added a fix to deal with 10000+ residues: residue number starts over
% at 1 after 9999. 2012-11-03
...
if isOldPDBStruct(pdbstruct)
    error('bioinfo:pdbwrite:OldPDBStructureDetected',...
        ['Old PDB structure is detected.\n',...
        'Please use ''getpdb'' or ''pdbread'' to regenerate new PDB structure.']);
end
...
% ML: attempt to deal with 10000+ residues: make residue number modulo
% 9999
